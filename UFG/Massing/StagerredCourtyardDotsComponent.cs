...
namespace DotsProj
{
    public class StagerredCourtyardDotsComponent : GH_Component
    {
        ...
        { 
            ...
            if (!DA.GetData(1, ref OFFSET_INP)) return;
            ...
            DA.SetData(4, cont);
            Curve OFFSET_CRV = c2Offs[0];
            DA.SetData(0, OFFSET_CRV);

            // PUT POINTS ON THE SITE
            ...
            // DA.SetDataList(2, lineLi); // 1st point is point on site, 2nd = normal @ setback dist
            ...
            DA.SetDataList(2, fLineLi); // 1st point is point on site, 2nd = normal @ setback dist
